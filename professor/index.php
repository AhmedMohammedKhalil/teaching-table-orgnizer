...
?>
    ...
    <div class="section" id="professor-profile">
      <div class="container">
        <h2 class="special-heading">Professor Profile</h2>
        <div class="kids-info flex">
          ...
          <div class="flex" style="flex-direction: row;">
            <a class="button" href="<?php echo $cont.'OfficeHourController.php?method=showOfficeHours' ?>" style="margin: 10px;">All Office Hours</a>
