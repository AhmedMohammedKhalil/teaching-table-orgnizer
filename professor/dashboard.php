	...
	<div class="section" style="min-height: calc(100vh - 172px);">
        <div class="container">
          ...
          <div style="display:flex;justify-content:space-evenly;margin:30px">
            <a class="button" href="<?php echo $cont.'SubjectController.php?method=getSubjects'?>">All Subjects</a>
            <a class="button" href="<?php echo $cont.'TableController.php?method=showMyTable' ?>">My Table</a>
          </div>
        </div>
    </div>
<?php
