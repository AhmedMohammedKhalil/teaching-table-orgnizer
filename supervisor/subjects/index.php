...
<div class="section" id="subjects" style="min-height: 76.3vh;">
  <div style="text-align: center;">
    <a class="button" href="<?php  echo $cont . 'SubjectController.php?method=showAddForm' ?>">Add Subject</a>
  </div>
  <div class="container" style="margin-top:30px">
    ...
    <table id="table">
        ...
        <tr>
          ...
          <td>
            <div class="flex" style="flex-direction: row;margin: 0;justify-content:space-evenly">
              <a href="<?php echo $cont . 'SubjectController.php?method=showEditForm&id=' . $s['id'] ?>">Edit</a>
              <a href="<?php echo $cont . 'SubjectController.php?method=delete&id=' . $s['id'] ?>">Delete</a>
            </div>
          </td>
        </tr>
      <?php }
      ...
      if (empty($subjects)) {
        echo "<tr><td colspan='10'>Subjects Not Found </td></tr>";
      }
      ?>
    </table>
