...
?>
	<div class="section" id="login" style="margin-bottom: 33px;">
      <div class="container">
        <h2 class="special-heading">Add Department Head</h2>
        <form action="<?php echo $cont."HeadController.php?method=add"?>" method="POST" class="form">
          <?php
            if(isset($_SESSION['errors'])) {
          ...
          <div style="display: flex;justify-content:center;flex-direction:column">
            ...
            <div>
                <input type="submit" name="add_head" value="Add">
            </div>
          </div>
        </form>
      </div>
